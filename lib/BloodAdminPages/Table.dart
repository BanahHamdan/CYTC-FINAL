...
import 'BloodDonatorsInfo.dart';

class BloodAdminBloodRequests extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: BloodAdminBloodRequestsPage(),
    );
  }
}

class BloodAdminBloodRequestsPage extends StatefulWidget {
  @override
  _BloodAdminBloodRequestsPageState createState() => _BloodAdminBloodRequestsPageState();
}

class _BloodAdminBloodRequestsPageState extends State<BloodAdminBloodRequestsPage> {
            ...
            children: [
              Table(
                ...
                columnWidths: {
                  ...
                  6: FlexColumnWidth(1),
                  7: FlexColumnWidth(1),
                  8: FlexColumnWidth(1), // Add new column width
                },
                children: [
                  TableRow(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          BloodDonatorsInfo()), // Implement the page
                                );
                              },
                              style: ElevatedButton.styleFrom(
                                backgroundColor: Color(0xFF071533),
