              ...
              children: [
                Card(
                  ...
                  child: Container(
                    color: Colors.transparent,
                    padding:
                        EdgeInsets.symmetric(horizontal: 11, vertical: 0.0),
                    child: Row(
                      children: [
                        Padding(
                          padding: const EdgeInsets.fromLTRB(5, 0, 5, 0),
                        ...
                        Expanded(
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: Color(0xFF071533).withOpacity(0.1),
                              borderRadius:
                                  BorderRadius.circular(7), // Circular edges
                            ),
                            child: Row(
                              children: [
                                Expanded(
      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            _buildDrawerItem(Icons.home, 'الرئيسية', 4),
            _buildDrawerItem(LineAwesomeIcons.graduation_cap_solid,
                'طلبات التدريب للخريجين', 5),
            _buildDrawerItem(
                LineAwesomeIcons.comment_dots, 'اقتراحات وافكار المستخدمين', 6),
            _buildDrawerItem(Icons.star, 'الانجازات', 8),
            _buildDrawerItem(Icons.contact_mail, 'الرسائل', 1),
            _buildDrawerItem(Icons.group_add, 'الانشطة', 9),
            _buildDrawerItem(Icons.person_add_alt_1, 'تغيير دور المستخدم',
                10), // New menu item
            // _buildDrawerItem(Icons.logout, 'تسجيل خروج', 7),
          ],
        ),
  ...
  Widget _buildDrawerItem(IconData icon, String title, int index) {
    ...
    return ListTile(
      ...
      title: Text(title,
          textAlign: TextAlign.right,
          style: TextStyle(
              fontFamily: 'Amiri', fontSize: 10, color: Colors.white)),
      trailing: Icon(icon,
          color: isSelected ? Color(0xFFffe145) : Colors.white, size: 15),
    );
  }
}
