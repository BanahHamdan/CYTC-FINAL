      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              onTap: () => _onItemTapped(5),
              title: Text('تقديم طلب تدريب للخريجين', textAlign: TextAlign.right, style: TextStyle(fontFamily: 'Amiri', fontSize: 11, color: Colors.white)),
              trailing: Icon(LineAwesomeIcons.graduation_cap_solid, color: Colors.white, size: 15),
            ),
            ListTile(
              onTap: () => _onItemTapped(6),
              title: Text('شاركنا باقتراحاتك وافكارك', textAlign: TextAlign.right, style: TextStyle(fontFamily: 'Amiri', fontSize: 11, color: Colors.white)),
              trailing: Icon(LineAwesomeIcons.comment_dots, color: Colors.white, size: 15),
            ),
            ListTile(
              onTap: () => _onItemTapped(8),
              title: Text('انجازاتنا', textAlign: TextAlign.right, style: TextStyle(fontFamily: 'Amiri', fontSize: 11, color: Colors.white)),
              trailing: Icon(Icons.star, color: Colors.white, size: 15),
            ),
            ListTile(
              onTap: () => _onItemTapped(1),
              title: Text('تواصل معنا', textAlign: TextAlign.right, style: TextStyle(fontFamily: 'Amiri', fontSize: 11, color: Colors.white)),
              trailing: Icon(Icons.contact_mail, color: Colors.white, size: 15),
            ),
            ListTile(
              onTap: () => _onItemTapped(9),
              title: Text('انضم لنا', textAlign: TextAlign.right, style: TextStyle(fontFamily: 'Amiri', fontSize: 11, color: Colors.white)),
