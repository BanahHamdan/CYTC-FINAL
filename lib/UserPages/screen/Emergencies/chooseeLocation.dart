...
//         SnackBar(
//             content: Text(
//           'Thanks for choosing! We have sent the location.',
//           textAlign: TextAlign.center,
//         )),
//       );
...
//           actions: [
//             IconButton(
//               icon: Icon(LineAwesomeIcons.check_solid, color: Colors.white), // Changed icon
//               onPressed: _saveLocation, // Updated function
//             ),
//           ],
//         ),
//         // ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GoogleMap(
        onMapCreated: _onMapCreated,
        initialCameraPosition: CameraPosition(
          target: LatLng(32.22399814117364, 35.262018884114724),
          zoom: 13.0,
        ),
        onTap: _onTap,
        markers: _chosenLocation == null
        ...
        children: <Widget>[
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: CircleAvatar(
                      radius: 30,
                      backgroundImage: AssetImage('assets/banah.jpg'),
                    ),
                  ),
                ],
              ),
          ...
          ListTile(
            onTap: () => Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        universityTrainingPage(userId: widget.userId,userRole: widget.userRole))),
            title: Text('تقديم طلب تدريب للخريجين',
                textAlign: TextAlign.right,
                style: TextStyle(
                    fontFamily: 'Amiri',
          ...
          ListTile(
            onTap: () => Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        SuggestionsPage(userId: widget.userId,userRole: widget.userRole))),
            title: Text('شاركنا باقتراحاتك وافكارك',
                textAlign: TextAlign.right,
                style: TextStyle(
                    fontFamily: 'Amiri',
          ...
          ListTile(
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => LoginPage(userId: widget.userId,))),
            title: Text('تسجيل خروج',
                textAlign: TextAlign.right,
                style: TextStyle(
                    fontFamily: 'Amiri',
