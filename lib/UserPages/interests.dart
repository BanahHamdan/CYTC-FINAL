...
//               ),
//               Text(
//                 'بناء على اختياراتك سنقوم بارسال اشعارات لك لجميع الانشطة التي تتعلق باهتماماتكك',
//                 textAlign: TextAlign.right,
//                 style: TextStyle(
//                   fontSize: 15,
//                   fontFamily: 'Amiri',
...
//           children: [
//             Container(
//               height: 60, // Adjust height to make the card rectangular
//               decoration: BoxDecoration(
//                 borderRadius: BorderRadius.circular(10),
//                 image: DecorationImage(
//                   image: AssetImage(imagePath),
...
//             ),
//             Container(
//               height: 60, // Adjust height to match the container height
//               decoration: BoxDecoration(
//                 borderRadius: BorderRadius.circular(10),
//                 color: _isSelected[index]
//                     ? Color(0xFF071533).withOpacity(0.5)
            ...
            children: [
              ...
              child: Text(
                ...
                style: TextStyle(
                  ...
                  Image.asset('assets/gif/listCheck1.gif', width: 150, height: 150,),
              // Row(
              //   children: [
                  Text(
                    'بناء على اختياراتك سنرسل لك اشعارات \n لجميع الانشطة التي تتعلق باهتماماتكك',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 15,
                      fontFamily: 'Amiri',
    ...
    return GestureDetector(
      ...
      child: Card(
        ...
        child: Stack(
          children: [
            Container(
              height: 50, // Adjust height to make the card rectangular
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(10),
                image: DecorationImage(
                  image: AssetImage(imagePath),
            ...
            Container(
              height: 50, // Adjust height to match the container height
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(10),
                color: _isSelected[index]
                    ? Color(0xFFffe145) //.withOpacity(0.7)
